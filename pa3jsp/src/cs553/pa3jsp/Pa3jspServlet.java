...
public class Pa3jspServlet extends HttpServlet {
        ...
        public void fileOpsUsingDataStoreOrCloudStore(HttpServletRequest req, HttpServletResponse resp)
                        throws ServletException, IOException  {
        ...
        public void performFind(User user, HttpServletRequest req, HttpServletResponse resp)
        ...
        Key k2 = new KeyFactory.Builder("user", user.getNickname())
            ...
            for (Entity result : pq.asIterable()) {  
                found = 1;
                String filesize = String.valueOf(result.getProperty("file-contentlen"));
                String filestore = (String) result.getProperty("file-store");
